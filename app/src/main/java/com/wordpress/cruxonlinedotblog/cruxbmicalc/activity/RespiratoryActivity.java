...
import com.wordpress.cruxonlinedotblog.cruxbmicalc.Fragments.FirstRespiratoryFragment;
import com.wordpress.cruxonlinedotblog.cruxbmicalc.Fragments.SecondRespiratoryFragment;
...
public class RespiratoryActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = findViewById(R.id.tab_respiratory);
        ViewPager viewPager = findViewById(R.id.viewpager);
        ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());

        //Adding Fragments

        adapter.AddFragment(new FirstRespiratoryFragment(), "Calculate");
        adapter.AddFragment(new SecondRespiratoryFragment(), "Text");
...
//            Email.putExtra(Intent.EXTRA_TEXT, "Dear Admin," + "");  //Email 's Greeting text//
                if (Email.resolveActivity(getPackageManager())!=null){
                    ...
                    Toast.makeText(RespiratoryActivity.this,"No email client Installed.", Toast
                            .LENGTH_SHORT).show();
                }
//            try {
//                startActivity(Intent.createChooser(Email, "Send Feedback From:"));
...
//            }
        ...
        menu.findItem(R.id.nav_respiratory).setChecked(true);
...
//            finish();
            ...
            startActivity(new Intent(RespiratoryActivity.this, MainActivity.class));
...
//            }
            ...
            startActivity(new Intent(RespiratoryActivity.this, BmiActivity.class));
            overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
        }else if (id == R.id.nav_cardiovascular) {
            startActivity(new Intent(RespiratoryActivity.this, CardiovascularActivity.class));
            overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
        }else if (id == R.id.nav_renal){
            startActivity(new Intent(RespiratoryActivity.this,RenalActivity.class));
            overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
            startAppAd.showAd();
        }else if (id == R.id.nav_leanMass) {
            startActivity(new Intent(RespiratoryActivity.this, LeanMassActivity.class));
            overridePendingTransition(R.anim.slide_in, R.anim.slide_out);
            startAppAd.showAd();
        }
